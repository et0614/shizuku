...
while True:
    ...
    rslt = vCom.change_mode(1,2,vrc.VRFCommunicator.Mode.Cooling)
    print('success' if rslt[0] else 'failed')
    ...
    rslt = vCom.change_fan_speed(1,2,vrc.VRFCommunicator.FanSpeed.High)
    print('success' if rslt[0] else 'failed')

    print('Changing direction of VRF1-2 to 45degree ...',end='')
    rslt = vCom.change_direction(1,2,vrc.VRFCommunicator.Direction.Degree_450)
    print('success' if rslt[0] else 'failed')
