...
# endregion
    ...
    def get_drybulb_temperature(self):
        ...
        """        
        return self.read_present_value(self.target_ip,'analogInput:' + str(self._member.DrybulbTemperature.value),Real)
    ...
    def get_relative_humidity(self):
        ...
        """        
        return self.read_present_value(self.target_ip,'analogInput:' + str(self._member.RelativeHumdity.value),Real)
    ...
    def get_global_horizontal_radiation(self):
        ...
        """        
        return self.read_present_value(self.target_ip,'analogInput:' + str(self._member.GlobalHorizontalRadiation.value),Real)
    ...
    def get_nocturnal_radiation(self):
        ...
        """        
        return self.read_present_value(self.target_ip,'analogInput:' + str(self._member.NocturnalRadiation.value),Real)
    ...
    def get_zone_drybulb_temperature(self,oUnitIndex,iUnitIndex):
        ...
        return self.read_present_value(self.target_ip,'analogInput:' + str(objNum),Real)
